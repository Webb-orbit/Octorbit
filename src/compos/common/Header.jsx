    ...
    return (
        <div className=' px-10 pt-10 h-fit w-full relative max-sm:px-2 max-sm:h-[80vh]'>
            ...
            <div className=' py-24 max-sm:py-10'>
                <h3 className=' text-center text-neutral-200 selection:text-black source-sans selection:bg-white text-[4rem] font-medium max-sm:text-[4rem] uppercase'>everything adsolute <br /> everything ramdom </h3>
            </div>
            <ShootingStars />
