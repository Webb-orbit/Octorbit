        ...
        <>
            <div className=' flex flex-col gap-5'>
                ...
                <div className='h-[80vh] w-full relative rounded-md overflow-hidden'>
                    <div ref={outputref} className={` overflow-y-scroll scrollbar selection:bg-black selection:text-white absolute top-0 bg-neutral-800 w-full h-full p-4 ${isactive ? "z-[10]" : "z-[20]"}`}></div>
                    <div className={` absolute top-0 bg-neutral-800 w-full h-full p-4 ${isactive ? "z-[20]" : "z-[10]"}`}>
